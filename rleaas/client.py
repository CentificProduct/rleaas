...
class Client:
    ...
    def __init__(
        ...
        self.Deployment = DeploymentsClient(self)
...
class AsyncClient:
    ...
    def __init__(
        ...
        self.Profile = ProfileClient(self)              # type: ignore[assignment]
        self.Deployment = DeploymentsClient(self)       # type: ignore[assignment]
